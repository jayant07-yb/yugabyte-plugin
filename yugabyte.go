...
func new() *yugabyte {
	...
	connProducer.Type = yugabyteTypeName
...
func (p *yugabyte) Initialize(ctx context.Context, req dbplugin.InitializeRequest) (dbplugin.InitializeResponse, error) {
...
func (p *yugabyte) Type() (string, error) {
	return yugabyteTypeName, nil
}

func (p *yugabyte) getConnection(ctx context.Context) (*sql.DB, error) {
...
func (p *yugabyte) UpdateUser(ctx context.Context, req dbplugin.UpdateUserRequest) (dbplugin.UpdateUserResponse, error) {
	if req.Username == "" {
...
func (p *yugabyte) changeUserPassword(ctx context.Context, username string, changePass *dbplugin.ChangePassword) error {
...
func (p *yugabyte) changeUserExpiration(ctx context.Context, username string, changeExp *dbplugin.ChangeExpiration) error {
	p.Lock()
	defer p.Unlock()
...
func (p *yugabyte) NewUser(ctx context.Context, req dbplugin.NewUserRequest) (dbplugin.NewUserResponse, error) {
...
func (p *yugabyte) DeleteUser(ctx context.Context, req dbplugin.DeleteUserRequest) (dbplugin.DeleteUserResponse, error) {
	p.Lock()
	defer p.Unlock()
...
func (p *yugabyte) customDeleteUser(ctx context.Context, username string, revocationStmts []string) error {
	db, err := p.getConnection(ctx)
	if err != nil {
		return err
	}
...
func (p *yugabyte) defaultDeleteUser(ctx context.Context, username string) error {
	db, err := p.getConnection(ctx)
	if err != nil {
		return err
	}
...
func (p *yugabyte) secretValues() map[string]string {
